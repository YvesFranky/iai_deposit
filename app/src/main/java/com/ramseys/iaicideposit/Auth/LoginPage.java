            ...
            doc.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    ...
                    if (mUsers.isRegister()){
                        if (mUsers.isAdmin()){
                            Toast.makeText(LoginPage.this, "Bienvenue à toi "+mUsers.getUname(), Toast.LENGTH_SHORT).show();
                            notice.setVisibility(View.VISIBLE);
                            login.setClickable(true);
                        }else {
                            Toast.makeText(LoginPage.this, "Bienvenue à toi "+mUsers.getUname(), Toast.LENGTH_SHORT).show();
                            startActivity(new Intent(LoginPage.this, EnrolPage.class));
                        }

                    }else {
                        Toast.makeText(LoginPage.this, "Enregistrement", Toast.LENGTH_SHORT).show();
